namespace Lab4.Migrations
{
    ...
    public partial class AppliedChange : DbMigration
    {
        public override void Up()
        {
            ...
            DropColumn("dbo.Attendances", "Attendeeld");
        }
        
        public override void Down()
        {
            AddColumn("dbo.Attendances", "Attendeeld", c => c.String(nullable: false, maxLength: 128));
            DropForeignKey("dbo.Attendances", "AttendeeId", "dbo.AspNetUsers");
            DropIndex("dbo.Attendances", new[] { "AttendeeId" });
            DropPrimaryKey("dbo.Attendances");
            AlterColumn("dbo.Attendances", "AttendeeId", c => c.String(maxLength: 128));
            AddPrimaryKey("dbo.Attendances", new[] { "CourseId", "Attendeeld" });
